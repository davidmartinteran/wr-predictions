// Copia exacta de src/lib/scoring/actual-rounds.ts para el bundle de Edge Functions.
// El bundler de supabase functions no puede importar fuera de supabase/functions/.
// Si cambia el original, volver a copiar este fichero.

import type { EliminationRound } from "./scoring-engine.ts";
